...
\begin{frame}[t]{formatted input: lesen in Schleife (1)}
	\onslide*<+> { \lstinputlisting[basicstyle=\tiny, linerange=begin-bad_idea2]{cpp-code/formatted-input-read.cpp} }
	\onslide*<+> { \lstinputlisting[basicstyle=\tiny, linerange=begin-good_idea1]{cpp-code/formatted-input-read.cpp} }
	\onslide*<+> { \lstinputlisting[basicstyle=\tiny, linerange=begin-good_idea2]{cpp-code/formatted-input-read.cpp} }
	\onslide*<+> { \lstinputlisting[basicstyle=\tiny, linerange=begin-read_line]{cpp-code/formatted-input-read.cpp} }
\end{frame}

\begin{frame}[t]{formatted input: lesen in Schleife (2)}
	\onslide*<+> { \lstinputlisting[firstnumber=0, basicstyle=\tiny, linerange={{read_line-facet}, {facet_end-application}}]{cpp-code/formatted-input-read.cpp} }
	\onslide*<+> { \lstinputlisting[firstnumber=0, basicstyle=\tiny, linerange={{read_line-locale}, {facet-application}}]{cpp-code/formatted-input-read.cpp} }
	\onslide*<+> { \lstinputlisting[firstnumber=0, basicstyle=\tiny, linerange={{read_line-facet}, {facet_end-}}]{cpp-code/formatted-input-read.cpp} }
\end{frame}
