...
\begin{frame}{\texttt{fstream}}
	...
	\begin{tabular}{ll}
		\textbf{Signatur}	&	Beschreibung	\\
		\texttt{void open(const char*, ios\_base::openmode)}	&	öffnet eine Datei	\\
		\texttt{void open(string const\& s, ios\_base::openmode m)}	&	same as above	\\
...
\begin{frame}{\texttt{stringstream}}
	...
	\begin{tabular}{ll}
		\textbf{Signatur}	&	Beschreibung	\\
		\texttt{basic\_string str() const}	&	gibt einen string mit dem Inhalt des Streams zurück	\\
		\texttt{void str(basic\_string\&)}	&	ersetzt den Inhalt des Streams durch eine Kopie des Inhalt des Strings	\\
	\end{tabular}
...
\begin{frame}{Aliase für streams}
	\texttt{
	\begin{tabular}{llll}
		basic\_ios	&	char	&	char\_traits < char >	&	ios	\\
		basi\_ios	&	wchar\_t	&	char\_traits < wchar\_t >	&	wios	\\
		basic\_istream	&	char	&	char\_traits < char >	&	istream	\\
		basic\_fstream	&	wchar\_t	&	char\_traits < wchar\_t >	&	wfstream	\\
	\end{tabular}
	}
